...
from .vision_transformer import Mlp, PatchEmbed, trunc_normal_, zeros_, ones_, DropPath, Identity
...
def cait_xxs_24(pretrained=False, return_transforms=False, **kwargs):
    model = CaiT(
        img_size=224, embed_dim=192, depth=24, num_heads=4, init_scale=1e-5, **kwargs
    )
...
def cait_xxs_36(pretrained=False, return_transforms=False, **kwargs):
    model = CaiT(
        img_size=224, embed_dim=192, depth=36, num_heads=4, init_scale=1e-5, **kwargs
    )
...
def cait_s_24(pretrained=False, return_transforms=False, **kwargs):
    model = CaiT(
        img_size=224, embed_dim=384, depth=24, num_heads=8, init_scale=1e-5, **kwargs
    )
...
def cait_xxs_24_384(pretrained=False, return_transforms=False, **kwargs):
    model = CaiT(
        img_size=384, embed_dim=192, depth=24, num_heads=4, init_scale=1e-5, **kwargs
    )
...
def cait_xxs_36_384(pretrained=False, return_transforms=False, **kwargs):
    model = CaiT(
        img_size=384, embed_dim=192, depth=36, num_heads=4, init_scale=1e-5, **kwargs
    )
...
def cait_xs_24_384(pretrained=False, return_transforms=False, **kwargs):
    model = CaiT(
        img_size=384, embed_dim=288, depth=24, num_heads=6, init_scale=1e-5, **kwargs
    )
...
def cait_s_24_384(pretrained=False, return_transforms=False, **kwargs):
    model = CaiT(
        img_size=384, embed_dim=384, depth=24, num_heads=8, init_scale=1e-5, **kwargs
    )
...
def cait_s_36_384(pretrained=False, return_transforms=False, **kwargs):
    model = CaiT(
        img_size=384, embed_dim=384, depth=36, num_heads=8, init_scale=1e-6, **kwargs
    )
...
def cait_m_36_384(pretrained=False, return_transforms=False, **kwargs):
    model = CaiT(
        img_size=384, embed_dim=768, depth=36, num_heads=16, init_scale=1e-6, **kwargs
    )
...
def cait_m_48_448(pretrained=False, return_transforms=False, **kwargs):
    model = CaiT(
        img_size=448, embed_dim=768, depth=48, num_heads=16, init_scale=1e-6, **kwargs
    )
